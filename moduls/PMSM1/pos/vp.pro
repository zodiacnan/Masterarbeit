...
DefineConstant[
  ...
  Flag_SrcType_Rotor = 0, 
  Flag_Cir_RotorCage = 0, 
  Flag_Cir_StatorRings=0,
...
PostOperation Get_LocalFields UsingPost MagStaDyn_a_2D {
  ...
  Print[ nb,  OnElementsOf Domain, 
  	 ...
  	 AppendTimeStepToFileName Flag_SaveAllSteps] ;
  Print[ h,  OnElementsOf Domain, 
  	 File StrCat[ResDir,"h",ExtGmsh], LastTimeStepOnly ] ;
  ...
  Print[ b_tangent, OnElementsOf Domain,
	 File StrCat[ResDir,"btang",ExtGmsh], LastTimeStepOnly,
	 AppendTimeStepToFileName Flag_SaveAllSteps] ;
  Print[ Velocity, OnElementsOf Domain,
	 File StrCat[ResDir,"Vk",ExtGmsh], LastTimeStepOnly,
	 AppendTimeStepToFileName Flag_SaveAllSteps] ;
  Print[ JouleLosses, OnElementsOf Domain,
	 File StrCat[ResDir,"JL",ExtGmsh], LastTimeStepOnly,
	 AppendTimeStepToFileName Flag_SaveAllSteps] ;
