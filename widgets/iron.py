...
class Iron_Set(QWidget):
    ...
    def initUI(self):
        ...
        right = QFormLayout()
        main1.addLayout(self.layout1)
        main1.addWidget(self.layout2)
    ...
    def left(self):
        ...
        self.layout1.addWidget(self.cal_a,16,0)
        ...
        self.layout1.addWidget(self.cal_a_t,16,1)
    def under(self):
    ...
    def right(self):
        ...
        self.calbutton.clicked.connect(self.cal_save)
